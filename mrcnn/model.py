...
def identity_block(input_tensor, kernel_size, filters, stage, block,
    ...
    x = KL.Add()([x, input_tensor])#x = KL.Add([x, input_tensor], mode='sum', name='res' + str(stage) + block)#
...
def conv_block(input_tensor, kernel_size, filters, stage, block, strides=(2, 2), use_bias=True, train_bn=True):
    ...
    x = KL.Add()([x, shortcut])#x = KL.Add([x, shortcut], mode='sum', name='res' + str(stage) + block)#
    x = KL.Activation('relu', name='res' + str(stage) + block + '_relu')(x)
    return x
...
class MaskRCNN():
    ...
    def set_log_dir(self, model_path=None):
        ...
        self.checkpoint_path = os.path.join(self.log_dir, "mask_rcnn_tumor.h5".format(
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers,
        ...
        callbacks = [
            ...
            keras.callbacks.ModelCheckpoint(self.checkpoint_path,monitor='val_loss',save_best_only=True,period=3,
